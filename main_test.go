...
import (
	...
	"github.com/Kairkhan/go-rest-api-ecommerce"
)
...
func TestGetNonExistentProduct(t *testing.T) {
	...
	if m["error"] != "Product not found" {
		t.Errorf(
			`Expected ther 'error' key of the response to be set to 'Product not found'. 
		Got '%s'`, m["error"])
	}
...
func TestUpdate(t *testing.T) {
	...
	if m["name"] == originalProduct["name"] {
		t.Errorf("Expected the name the change from '%v' to '%v'. Got '%v'", originalProduct["name"], m["name"], m["name"])
	}
